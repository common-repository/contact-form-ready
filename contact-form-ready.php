...
//		add_action('wpcf_gdpr_reg_cron_hook', array( $this, 'wpcf_gdpr_register_cron') );
	...
	function wpcf_main_control( $post ) {
		...
		$modal_el_attr = !empty($wpcf_nd_basic_settings['wpcf_nd_modal_el_attr']) ? $wpcf_nd_basic_settings['wpcf_nd_modal_el_attr'] : '';
		$modal_el = !empty($wpcf_nd_basic_settings['wpcf_nd_modal_el']) ? $wpcf_nd_basic_settings['wpcf_nd_modal_el'] : '';
		$modal_bg = !empty($wpcf_nd_basic_settings['wpcf_nd_modal_bg']) ? $wpcf_nd_basic_settings['wpcf_nd_modal_bg'] : '';
		$modal_opacity = !empty($wpcf_nd_basic_settings['wpcf_nd_modal_opacity']) ? $wpcf_nd_basic_settings['wpcf_nd_modal_opacity'] : '';
		$modal_inner_bg = !empty($wpcf_nd_basic_settings['wpcf_nd_modal_inner_bg']) ? $wpcf_nd_basic_settings['wpcf_nd_modal_inner_bg'] : '';
			...
			<div id='basic-settings'>
				...
				<table class='form-table'>
			    	...
			    	<tr>
			    		...
			    		<td>
			    			<input id="wpcf-shortcode-input" class="wpcf_shortcode_copy" type='text' readonly value='[cform-nd id="<?php echo intval($post->ID); ?>"]' />
			    	...
			    	<tr>
			    		...
			    		<td>
			    			<input type='text' value='<?php echo esc_attr($sendto); ?>' id='wpcf_nd_send_to' name='wpcf_nd_send_to' class='regular-text' />
			    	...
			    	<tr>
			    		...
			    		<td>
			    			<input type='text' value='<?php echo esc_attr($wpcf_nd_redirect_uri); ?>' id='wpcf_nd_redirect_uri' name='wpcf_nd_redirect_uri' class='regular-text code' />
			    	...
			    	<tr>
			    		...
			    		<td><input type='text' value='<?php echo esc_attr($submit_string); ?>' id='wpcf_nd_submit_string' name='wpcf_nd_submit_string' /></td>
			    	</tr>
			    	<tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type='text' value='<?php echo esc_attr($modal_el); ?>' id='wpcf_nd_modal_el' name='wpcf_nd_modal_el' />
                    ...
                    <tr class="wpcf-modal-customization is-active">
                        ...
                        <td><input type='color' value='<?php echo esc_attr($modal_bg); ?>' id='wpcf_nd_modal_bg' class='wpcf-color-input' name='wpcf_nd_modal_bg' /></td>
                    </tr>
                    <tr class="wpcf-modal-customization is-active">
                        <td><label for='wpcf_nd_modal_opacity'><?php _e( "Modal wrapper opacity", "wpcf_nd" ); ?></label></td>
                        <td>
                            <input type='text' value='<?php echo floatval($modal_opacity); ?>' id='wpcf_nd_modal_opacity' name='wpcf_nd_modal_opacity' />
                    ...
                    <tr class="wpcf-modal-customization is-active">
                        ...
                        <td><input type='color' value='<?php echo esc_attr($modal_inner_bg); ?>' id='wpcf_nd_modal_inner_bg' class='wpcf-color-input' name='wpcf_nd_modal_inner_bg' /></td>
                    </tr>
			...
			<div id='advanced-settings'>
				...
				<table class='form-table'>
					<tr>
						...
						<td><input type='text' name='wpcf_nd_subject_admin' class='regular-text' id='wpcf_nd_subject_admin' value='<?php echo esc_attr($cfr_email_subject_admin) ?>' /></td>
					</tr>
					<tr>
						<td><?php _e("Email body (admin)","wpcf_nd"); ?></td>
						<td><input type='text' name='wpcf_nd_message_admin' class='regular-text' id='wpcf_nd_message_admin' value='<?php echo esc_attr($cfr_email_body_admin) ?>' /></td>
					</tr>
					...
					<tr>
						...
						<td><input type='text' name='wpcf_nd_subject_user' class='regular-text' id='wpcf_nd_subject_user' value='<?php echo esc_attr($cfr_email_subject_user); ?>' /></td>
					</tr>
					<tr>
						<td><?php _e("Email body (user)","wpcf_nd"); ?></td>
						<td><input type='text' name='wpcf_nd_message_user' class='regular-text' id='wpcf_nd_message_user' value='<?php echo esc_attr($cfr_email_body_user); ?>' /></td>
					</tr>
	...
	function privacy_settings_content( $wpcf_nd_settings ) { ?>
        ...
        <table class='wp-list-table fixed'>
            ...
            <tr>
                ...
                <td><input type='text' name='wpcf_nd_gdpr_company_name' class='regular-text' id='wpcf_nd_gdpr_company_name' value='<?php echo esc_attr($cfr_gdpr_company_name); ?>' /></td>
            </tr>
            <tr>
                <td width='250'><label for="wpcf_nd_gdpr_retention_purpose"><?php _e("Retention Purpose","wpcf_nd"); ?></label></td>
                <td><input type='text' name='wpcf_nd_gdpr_retention_purpose' class='regular-text' id='wpcf_nd_gdpr_retention_purpose' value='<?php echo esc_attr($cfr_gdpr_retention_purpose); ?>' /></td>
            </tr>
            <tr>
                <td width='250'><label for='wpcf_nd_gdpr_retention_period'><?php _e("Retention Period","wpcf_nd"); ?></label></td>
                <td><input type='text' name='wpcf_nd_gdpr_retention_period' id='wpcf_nd_gdpr_retention_period' value='<?php echo intval($cfr_gdpr_retention_period); ?>' /> <span class='description'><?php echo __("days","wpcf_nd");  ?></span></td>
            </tr>
            <tr>
                <td width='250'><label for="wpcf_nd_gdpr_notice"><?php _e("GDPR Notice","wpcf_nd"); ?></label></td>
                <td><textarea name='wpcf_nd_gdpr_notice' class='regular-text' id='wpcf_nd_gdpr_notice' rows="6"><?php echo esc_attr($cfr_gdpr_notice); ?></textarea></td>
            </tr>
            <tr>
    ...
    function disable_gdpr_notice() {
	    if ( isset($_GET['post_type']) && $_GET['post_type'] === 'contact-forms-nd' ) {
		    ...
		    if ( ! $cfr_enable_gdpr ) { ?>
                <div class="update-nag notice notice-error is-dismissible wpcf_gdpr_notice" style="border-color: #dd0000; max-width: 600px;margin-left: 0; display:block;">
	...
	function load_user_scripts() {
		...
		$localizedData['invisible_recaptcha_options'] = $invisible_recaptcha_localize_options;
		$localizedData['wpcf_nd_nonce'] = $wpcf_nonce;
		$localizedData['wpcf_nd_ajaxurl'] = $wpcf_ajaxurl;

		$localizedData['wpcf_nd_ajax_thank_you'] = stripslashes( esc_html( $wpcf_nd_settings['wpcf_nd_message_user'] ) ) ;
		$localizedData['wpcf_nd_ajax_sending'] = __("Sending...","wpcf_nd");

		wp_localize_script( 'contact-form-ready', 'wpcf_localized_client', $localizedData );
	...
	function load_admin_scripts() {
	    ...
	    if( "contact-forms-nd" == $post_type ) {
			...
			if ( is_object( $post ) ) {
                ...
                wp_localize_script( 'wpcf-admin', 'tmpformData', array('json' => $formdata) );
            } else {
		...
		if ( isset( $_GET['page'] ) && $_GET['page'] == 'wpcf-settings') {
	        ...
	        wp_localize_script( 'wpcf-admin-settings', 'wpcf_nd_confirm_restore_template_string', array('label' => __( 'Are you sure you want to restore the default newsletter template?', 'wpcf_nd' )) );
	...
	function wpcf_can_save_settings(){
		if(current_user_can('manage_options')){
			$nonce = !empty($_POST['wpcf_save_settings']) ? $_POST['wpcf_save_settings'] : false;
			if(!empty($nonce) && wp_verify_nonce($nonce, 'wpcf_save_settings')){
				return true;
			}
		}
		return false;
	...
	function wpcf_styling_page() {
		...
		if (isset($_POST['wpcf_submit_save_styling'])) {
			if($this->wpcf_can_save_settings()){
        ...
        <form action='' method='POST' name='wpcf_styling_form' class="wpcf-styling-form">
					...
					<div id="sola_cfr_styling_tabs">
						...
						<div id="tabs-1">
							<table class='wp-list-table fixed wpcf-admin-table'>
								...
								<tr>
									...
									<td><input type='number' name='wpcf_nd_label_font_size' class='regular-text wpcf-nd-small-input' id='wpcf_nd_label_font_size' value='<?php echo intval($wpcf_nd_styling['wpcf_nd_label_font_size']); ?>' min="10" max="62" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type='color' name='wpcf_nd_label_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_label_color' value='<?php echo stripslashes(esc_attr($wpcf_nd_styling['wpcf_nd_label_color'])); ?>' /></td>
								</tr>
								</tbody>
							</table>
						</div>
							...
							<table class='wp-list-table fixed wpcf-admin-table'>
								<tbody>
									<tr>
										...
										<td><input type='color' name='wpcf_nd_input_bg_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_input_bg_color' value='<?php echo stripslashes(esc_attr($wpcf_nd_styling['wpcf_nd_input_bg_color'])); ?>' /></td>
									</tr>
									<tr>
										<td width='250'><?php _e("Border color","wpcf_nd"); ?></td>
										<td><input type='color' name='wpcf_nd_input_border_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_input_border_color' value='<?php echo stripslashes(esc_attr($wpcf_nd_styling['wpcf_nd_input_border_color'])); ?>' /></td>
									</tr>
									<tr>
										<td width='250'><?php _e("Border hover color","wpcf_nd"); ?></td>
										<td><input type='color' name='wpcf_nd_input_border_focus_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_input_border_focus_color' value='<?php echo stripslashes(esc_attr($wpcf_nd_styling['wpcf_nd_input_border_focus_color'])); ?>' /></td>
									</tr>
									<tr>
										<td width='250'><?php _e("Font size","wpcf_nd"); ?></td>
										<td><input type='number' name='wpcf_nd_input_font_size' class='regular-text wpcf-nd-small-input' id='wpcf_nd_input_font_size' value='<?php echo stripslashes(esc_attr($wpcf_nd_styling['wpcf_nd_input_font_size'])); ?>' min="10" max="62" /></td>
									</tr>
									<tr>
										<td width='250'><?php _e("Font color","wpcf_nd"); ?></td>
										<td><input type='color' name='wpcf_nd_input_font_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_input_font_color' value='<?php echo (esc_attr($wpcf_nd_styling['wpcf_nd_input_font_color'])); ?>' /></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div id="tabs-3">
							<table class='wp-list-table fixed wpcf-admin-table'>
								...
								<tr>
									<td width='250'><?php _e("Background color","wpcf_nd"); ?></td>
									<td><input type='color' name='wpcf_nd_submit_bg_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_submit_bg_color' value='<?php echo (esc_attr($wpcf_nd_styling['wpcf_nd_submit_bg_color'])); ?>' /></td>
								</tr>
								<tr>
									<td width='250'><?php _e("Background hover color","wpcf_nd"); ?></td>
									<td><input type='color' name='wpcf_nd_submit_bg_hover_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_submit_bg_hover_color' value='<?php echo (esc_attr($wpcf_nd_styling['wpcf_nd_submit_bg_hover_color'])); ?>' /></td>
								</tr>
								<tr>
									<td width='250'><?php _e("Font size","wpcf_nd"); ?></td>
									<td><input type='number' name='wpcf_nd_submit_font_size' class='regular-text wpcf-nd-small-input' id='wpcf_nd_submit_font_size' value='<?php echo (intval($wpcf_nd_styling['wpcf_nd_submit_font_size'])); ?>' min="10" max="62" /></td>
								</tr>
								<tr>
									<td width='250'><?php _e("Font color","wpcf_nd"); ?></td>
									<td><input type='color' name='wpcf_nd_submit_font_color' class='regular-text wpcf-nd-small-input wpcf-color-input' id='wpcf_nd_submit_font_color' value='<?php echo (esc_attr($wpcf_nd_styling['wpcf_nd_submit_font_color'])); ?>' /></td>
								</tr>
								<tr>
									<td width='250'><?php _e("Font weight","wpcf_nd"); ?></td>
									<td>
			...
			<?php wp_nonce_field('wpcf_save_settings', 'wpcf_save_settings'); ?>
	...
	function wpcf_settings_page() {
		...
		if (isset($_GET['page']) && $_GET['page'] == 'wpcf-settings' && isset($_GET['action']) && ($_GET['action'] == 'wpcf_nd_welcome' || $_GET['action'] == 'wpcf_nd_credits')) {
			...
			if (!empty($wpcf_nd_settings['wpcf_custom_css'])) { 
				wp_add_inline_style( 'contact-form-ready', wp_strip_all_tags( $wpcf_nd_settings['wpcf_custom_css'] ) );
			}
					...
					<div id="tabs-1">
						...
						<table class='wp-list-table fixed'>
							<tr>
								...
								<td><input type='text' name='wpcf_nd_email_from_address' class='regular-text' id='wpcf_nd_email_from_address' value='<?php echo esc_attr($wpcf_nd_settings['wpcf_nd_email_from_address']); ?>' /></td>
							</tr>
							<tr>
								<td width='250'><label for="wpcf_nd_email_from_name"><?php _e("Email from name","wpcf_nd"); ?></label></td>
								<td><input type='text' name='wpcf_nd_email_from_name' class='regular-text' id='wpcf_nd_email_from_name' value='<?php echo esc_attr($wpcf_nd_settings['wpcf_nd_email_from_name']); ?>' /></td>
							</tr>
							<tr>
								<td width='250'><label for="wpcf_nd_thank_you_text"><?php _e("Thank you text","wpcf_nd"); ?></label></td>
								<td><input type='text' name='wpcf_nd_thank_you_text' class='regular-text' id='wpcf_nd_thank_you_text' value='<?php echo esc_attr($wpcf_nd_settings['wpcf_nd_thank_you_text']); ?>' /></td>
							</tr>
						</table>
					</div>
					...
					<div id="tabs-5">
						...
						<table class='wp-list-table fixed'>
							<tr id="wpcf_custom_css_tr_container">
								...
								<td id="wpcf_custom_css_container"><textarea name="wpcf_custom_css" id="wpcf_custom_css" cols="70" rows="10" spellcheck="false"><?php if(isset($wpcf_nd_settings['wpcf_custom_css']) && $wpcf_nd_settings['wpcf_custom_css'] != "") { echo wp_strip_all_tags($wpcf_nd_settings['wpcf_custom_css']); } ?></textarea></td>
							</tr>
	...
	function custom_column( $column, $post_id ) {
	    switch ( $column ) {
	        ...
	        case 'submissions' :
				...
				break;
			case 'shortcode' :
				echo '<pre>[cform-nd id="'. intval($post_id).'"]</pre>';						
				break;
	...
	function wpcf_tag( $atts ) {
		...
		if (isset($atts['id'])) {
	    	...
	    	if ($wpcf_thank_you) {
				...
				$formLocalize['wpcf_nd_form_type'] = $form_type;

				$wpcf_nd_redirect_uri = get_post_meta( $atts['id'], 'wpcf_nd_redirect_uri', true );
		    	if ($wpcf_nd_redirect_uri) {
		    		$formLocalize['wpcf_nd_form_redirect'] = get_option("siteurl") . $wpcf_nd_redirect_uri;
		    	}

				wp_localize_script( 'contact-form-ready', 'wpcf_nd_form_localize', $formLocalize );
...
if ( function_exists( 'register_block_type_from_metadata' ) ) {
	...
	function cfr_gutenberg_block_renderer() {
		...
		// Localize the forms for selection
		$forms = get_posts(
			array(
				'numberposts' => -1, 
				'post_type' => 'contact-forms-nd'
		...
		// Register block type using the new JSON definition approach, this will enqueue the assets
		register_block_type_from_metadata(
			plugin_dir_path(__FILE__) . '/gutenberg/',
			array(
	...
	function cfr_gutenberg_block_render( $attributes ) {
		if(empty($attributes['cfid'])){
			return "<p style='padding:10px;'>Please Select A Form</p>";
		}	
		...
		$shortcode = do_shortcode('[cform-nd id="' . intval($attributes['cfid']) . '"]');
		return "<div {$style}>{$shortcode}</div>";
	}
}