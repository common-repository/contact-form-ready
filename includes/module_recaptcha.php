	...
	<table class="wp-list-table fixed" >
		<tbody>
			...
			<tr>
				...
				<td><input type='text' name='wpcf_nd_recaptcha_site_key' class='regular-text' id='wpcf_nd_recaptcha_site_key' value='<?php echo esc_attr($wpcf_nd_settings['wpcf_nd_recaptcha_site_key']); ?>' /></td>
			</tr>
			<tr>
				<td><label for='wpcf_nd_recaptcha_secret_key'><?php _e("Secret key","wpcf_nd"); ?></label></td>
				<td><input type='text' name='wpcf_nd_recaptcha_secret_key' class='regular-text' id='wpcf_nd_recaptcha_secret_key' value='<?php echo esc_attr($wpcf_nd_settings['wpcf_nd_recaptcha_secret_key']); ?>' /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
			...
			<tr>
				...
				<td><input type='text' name='wpcf_nd_invisible_recaptcha_site_key' class='regular-text' id='wpcf_nd_invisible_recaptcha_site_key' value='<?php echo esc_attr($wpcf_nd_settings['wpcf_nd_invisible_recaptcha_site_key']); ?>' /></td>
			</tr>
			<tr>
				<td><label for='wpcf_nd_invisible_recaptcha_secret_key'><?php _e("Secret key","wpcf_nd"); ?></label></td>
				<td><input type='text' name='wpcf_nd_invisible_recaptcha_secret_key' class='regular-text' id='wpcf_nd_invisible_recaptcha_secret_key' value='<?php echo esc_attr($wpcf_nd_settings['wpcf_nd_invisible_recaptcha_secret_key']); ?>' /></td>
			</tr>
		</tbody>			
	</table>
